...
public class World extends JPanel implements Runnable {
    ...
    /**
     * Initializes the world, the drawing window, and starts the update thread in
     * the background.
     * 
     * @param creatures The {@link Creature} instances that exist at the beginning
     *                  of the game.
     */
    public World(List<Creature> creatures) {
        ...
        // size of the world.
        _cell = new Dimension(_world.width / _totalStartingCreatures, _world.height / _totalStartingCreatures);
    ...
    /**
     * This function is called on the background thread by virtue of the
     * {@link java.lang.Runnable} interface.
     * <p>
     * Every time it's called, we update all of the creatures, redraw the window,
     * and take a brief .25 sleep so the game doesn't run blindingly fast.
     */
    public void run() {
